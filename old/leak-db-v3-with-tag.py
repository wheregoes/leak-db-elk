                    ...
                    try:
                        ...
                        if args.combolist and len(fields) == 2:
                            ...
                            if entry_exists(es, index_name, hash_value):
                                ...
                                if insert_new_entry(es, index_name, timestamp, hash_value, user=user, password=password, tag=args.TAG):
                            ...
                            if entry_exists(es, index_name, hash_value):
                                ...
                                if insert_new_entry(es, index_name, timestamp, hash_value, user=user, password=password, url=url, tag=args.TAG):
